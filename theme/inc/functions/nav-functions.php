...
namespace Extramile\Theme\Navwalker;

use Walker_Nav_Menu;

//extend navwalker class to add custom functionality
...
class walkernav extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        // if there are 2 or more megamenu set same behaviour for all of them
        if ($this->megaMenuID != 0) {
            $classes[] = 'megamenu';
        }
        ...
        $item_output .= (($depth == 0 || 1) && $args->has_children) ? ' <i class="fas fa-angle-down"></i></a>' : '</a>';
